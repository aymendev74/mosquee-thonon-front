...
export const getConsentementInscriptionCoursLibelle = () => "En soumettant ce formulaire, vous consentez à ce que l'association musulmane du chablais (AMC) et l'association lettres et cultures (ALC) collectent et traitent vos données personnelles aux fins de votre inscription aux cours." +
    " Vos données seront conservées pendant toute la durée de votre inscription et seront accessibles pour consultation ou modification sur demande, par e-mail à l'adresse suivante: amcinscription@gmail.com." +
    " Vous vous engagez également à respecter le règlement intérieur établi par les associations AMC et ALC, disponible sur demande auprès de leurs membres et affiché dans les locaux.";
